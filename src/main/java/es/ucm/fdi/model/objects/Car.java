...
public class Car extends Vehicle {
	...
	private int kmSinceLastFaulty; // Kilometros recorridos desde la última
									// avería
	 ...
	 * 
	 * @deprecated Por requerir el uso de la constructora no aconsejada de
	 *             Vehicle.
	 * @param res
	 *            Resistencia del vehículo a las averías en km.
	 * @param fProb
	 *            Factor de probabilidad de avería del vehículo.
	 * @param mFDur
	 *            Máxima duración de avería del vehículo.
	 * @param s
	 *            Semilla de números aleatorios.
	 */
	public Car(int res, double fProb, int mFDur, long s, String id, int maxSpeed,
			String[] trayecto, RoadMap map) {
	 ...
	 * @deprecated
	 */
	public Car(int res, double fProb, int mFDur, String id, int maxSpeed,
			String[] trayecto, RoadMap map) {
		this(res, fProb, mFDur, System.currentTimeMillis(), id, maxSpeed, trayecto, map);
	}

	/**
	 * Genera aleatoriamente dentro de un rango acotado por
	 * {@link #maxFaultDuration} el tiempo que estará averiado el vehículo.
	 */
	public int tiempoAveria() {
		return random.nextInt(maxFaultDuration) + 1;
	}
	/**
	 * Para decidir junto con {@link #faultProbability} si se avería el vehículo
	 * o no de forma aleatoria.
	 */
