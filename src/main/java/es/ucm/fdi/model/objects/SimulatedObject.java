 ...
 * identificador y su funcionalidad más básica. De esta clase heredan todos los
 * objetos del simulador de tráfico.
 * 
...
public abstract class SimulatedObject implements Describable {
	 ...
	 *
	 * @param identificador
	 *            El identificador del nuevo objeto. (debe ser alfanumérico).
	 */
	...
	/**
	 * Escribe el informe del objeto en un determinado momento con el formato
	 * IniSection.
	 * 
	 * @deprecated Porque es mejor que el objeto solo se pase a mapa y otro lo
	 *             lleve a IniSection.
	 * @param out
	 *            Flujo de salida en el que escribir el informe.
	 * @param time
	 *            Tiempo en el que se escribe el informe.
	 * @throws IOException
	 *             si hay problemas en la escritura.
	 */
	...
	/**
	 * Introduce en el mapa pasado como paámetro la información del estado del
	 * objeto.
	 * 
	 * @param time
	 *            Tiempo en el que se genera el informe.
	 * @param camposValor
	 *            Mapa en el que se introduce la información. Se presupone vacío
	 *            para asegurar la corrección de otros métodos.
	 */
	public void report(int time, Map<String, String> camposValor) {
		// Este método se hace para tener toda la generalidad posible, no
		// depende de un flujo de salida
		// Simplemente rellena un mapa<String,String> con toda la información
		// necesaria.
	...
	/**
	 * Método encargado de introducir en el mapa con el infome los campos
	 * específicos de cada simObject.
	 */
	...
	/**
	 * Completa los aspectos únicos de cada informe. Específico para cada
	 * objeto.
	 */
