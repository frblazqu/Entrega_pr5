...
/**
 * RoadMap es la clase encargada de almacenar todos los objetos que forman parte
 * de la simulación. Permite acceder a estos por su identificador y preserva en
 * todo momento la unicidad de este
 * 
...
public class RoadMap {
	...
	private Map<String, SimulatedObject> simObjects; // Búsqueda por ids,
														// unicidad
	private Map<String, List<ConexionCruces>> connectedJunctions; // Cruces y
																	// carreteras
																	// que los
																	// unen
	...
	// MÉTODOS BUENOS
	/**
	 * It doesn't matter whether the object is an vehicle, junction or a road.
	 * This method just adds it to the map.
	 */
	 ...
	 * 
	 * @return true if the key is already used. False in other case.
	 */
	...
	/**
	 * As an usual map does, this returns the mapped object or null if there is
	 * no vehicle in the map with that id.
	 */
	...
	/**
	 * As an usual map does, this returns the mapped object or null if there is
	 * no Junction in the map with that id.
	 */
	...
	/**
	 * As an usual map does, this returns the mapped object or null if there is
	 * no Road in the map with that id.
	 */
